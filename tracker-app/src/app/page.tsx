...
export default async function DashboardPage(props: { searchParams?: Promise<{ resourceId?: string }> }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-h-[60vh]">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6">
          <h3 className="text-lg font-semibold text-red-800">Overdue</h3>
          <ul className={`mt-4 space-y-4 ${overdue.length > 2 ? 'overflow-auto h-[50vh]' : ''}`}>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
          ...
          <ul className={`mt-4 space-y-4 ${thisWeek.length > 2 ? 'overflow-auto h-[50vh]' : ''}`}>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className={`mt-4 space-y-4 ${upcoming.length > 2 ? 'overflow-auto h-[50vh]' : ''}`}>

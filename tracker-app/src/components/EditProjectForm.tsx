      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {customers && (
          <div className='text-[12px]'>
            ...
            <Select
              ...
              name="customerId"
              options={options || []}
              defaultValue={options.find((opt:any) => opt.value === editingProject?.customerId)}
              isSearchable={true}
        ...
        <div>
          ...
          <input
            ...
            defaultValue={editingProject?.numberOfUsersForBilling || ''}
            min="1"
            required
            className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border"
          />
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="flex gap-2">
            <button
              ...
              className={` ${role == 'Admin' ? 'cursor-pointer' : 'cursor-not-allowed'} text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 px-3 py-1.5 rounded-md disabled:opacity-50`}
            >
